...
Canon as of **D185** (2026-09-10). One page of current truth. When a new
...
happened or hard-failed (D94), a bounce-resurrect TTL forfeit (D185 —
not a pause, not a refill; campaign stays ACTIVE, lead stays dead). Plus `ops_alert` pages — the machine
