...
export const CLIENT_WORKSPACE_RULES: ClientWorkspaceRule[] = [
  ...
  },
  {
    ...
    clientName: /tj johnson|culture\s*fits?|culturefits/i,
  ...
  },
  {
    ...
    clientName: /tapper|tech\s*evo|techevolution/i,
