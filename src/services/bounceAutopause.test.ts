...
describe("BounceAutopauseService", () => {
  it("sets Under-1k and Goliath to 20% and leaves Over-1k alone (D67/D73)", async () => {
    ...
    const service = new BounceAutopauseService(
      ...
      client({
        campaigns: [
          ...
          { id: 3815447, name: "Goliath Displacement M 201-500 CIO", status: "PAUSED" },
        ],
        onUpdate: (id, body) => {
    ...
    assert.deepEqual(wrote, [
      ...
      { id: 3815448, threshold: "20" },
      { id: 3815447, threshold: "20" },
    ]);
  });
